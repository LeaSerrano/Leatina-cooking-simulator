...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class XRKnob : XRBaseInteractable
    {
        ...
        [SerializeField]
        [Tooltip("The axis around which the knob should rotate")]
        ...
        void SetKnobRotation(float angle)
        {
            ...
            if (m_Handle != null)
            {
                ...
                // Determine the rotation axis vector based on the selected axis
                switch (rotationAxis)
                {
                    case RotationAxis.X:
                    ...
                    case RotationAxis.Z:
                        ...
                        break;
                    default:
                        rotationAxisVector = Vector3.up; // Default to Y axis
                        break;
                }

                // Apply rotation around the selected axis
                m_Handle.localRotation = Quaternion.AngleAxis(angle, rotationAxisVector);
            }
        }
